...
const OfferteGenPage = () => {
  ...
  return (
    ...
    <div className=' absolute right-14 bottom-10 p-4 rounded-full bg-white cursor-pointer'>
        <svg onClick={() => navigate("/chatbot")} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-10 hover:scale-95">
